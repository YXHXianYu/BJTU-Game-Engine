...
// here 0.4999 is to avoid z-fighting
const std::vector<Vertex> RenderMeshBlocks::m_cube = {
    Vertex{0.5, 0.4999, -0.5, -0, 1, -1, 0.625, 0.5},      Vertex{-0.5, 0.4999, -0.5, -0, 1, -1, 0.875, 0.5},
    Vertex{-0.5, 0.4999, 0.5, -0, 1, 1, 0.875, 0.75},      Vertex{0.5, 0.4999, 0.5, -0, 1, 1, 0.625, 0.75},

    Vertex{-0.5, -0.4999, -0.5, -0, -1, -1, 0.125, 0.5},   Vertex{0.5, -0.4999, -0.5, -0, -1, -1, 0.375, 0.5},
    Vertex{0.5, -0.4999, 0.5, -0, -1, 1, 0.375, 0.75},     Vertex{-0.5, -0.4999, 0.5, -0, -1, 1, 0.125, 0.75},

    Vertex{0.5, -0.5, 0.4999, -0, -0, 1, 0.375, 0.75},     Vertex{0.5, 0.5, 0.4999, -0, -0, 1, 0.625, 0.75},
    Vertex{-0.5, 0.5, 0.4999, -0, -0, 1, 0.625, 1},        Vertex{-0.5, -0.5, 0.4999, -0, -0, 1, 0.375, 1},

    Vertex{-0.5, -0.5, -0.4999, -0, -0, -1, 0.375, 0.25},  Vertex{-0.5, 0.5, -0.4999, -0, -0, -1, 0.625, 0.25},
    Vertex{0.5, 0.5, -0.4999, -0, -0, -1, 0.625, 0.5},     Vertex{0.5, -0.5, -0.4999, -0, -0, -1, 0.375, 0.5},

    Vertex{-0.4999, -0.5, 0.5, -0.5, -0, 1, 0.375, 0},     Vertex{-0.4999, 0.5, 0.5, -0.5, -0, 1, 0.625, 0},
    Vertex{-0.4999, 0.5, -0.5, -0.5, -0, -1, 0.625, 0.25}, Vertex{-0.4999, -0.5, -0.5, -0.5, -0, -1, 0.375, 0.25},

    Vertex{0.4999, -0.5, -0.5, 0.5, -0, -1, 0.375, 0.5},   Vertex{0.4999, 0.5, -0.5, 0.5, -0, -1, 0.625, 0.5},
    Vertex{0.4999, 0.5, 0.5, 0.5, -0, 1, 0.625, 0.75},     Vertex{0.4999, -0.5, 0.5, 0.5, -0, 1, 0.375, 0.75},
};
